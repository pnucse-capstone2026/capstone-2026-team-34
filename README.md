...
> **작성 필요** — 멘토링 회차별 피드백과 반영 내용을 정리해 주세요.
>
> | 회차 | 멘토 의견 | 반영 사항 |
> | --- | --- | --- |
> |  |  |  |
...
> **작성 필요** — 시연 영상 링크를 추가해 주세요.
>
> ```markdown
> [![TriPick 시연 영상](http://img.youtube.com/vi/{VIDEO_ID}/0.jpg)](https://youtu.be/{VIDEO_ID})
> ```
